...
observations, etc. to the 
[GitHub issues area](https://github.com/PhilterPaper/Text-KnuthPlass/issues?q=is%3Aissue+sort%3Aupdated-desc "issues").
We will try to tag new threads accordingly, using ["Labels"].

Please also read any RoadMaps or road map-related issues to get an idea of where we would like for 
...
For code changes, a GitHub pull request (PR), a formal patch file (e.g., "diff"), or 
...
It is a waste of both _your_ and _our_ time and effort. A PR is for code and files
intended to become a **permanent** part of the product! Instead, open a regular ticket
(issue), and _attach_ a Perl (.pl) program illustrating the problem, if possible. 
If you believe that you have a program patch (for either a bug, or a new feature), 
and offer to share it as a PR, wait until we give the go-ahead. Unsolicited PRs 
...
You are free to try contributing anything you want, or even to _fork_ the project 
...
on Text::KnuthPlass functionality, but it doesn't fit our roadmap for core 
functionality, we may suggest that you release it as a separate package on CPAN 
(dependent on Text::KnuthPlass), or as a new sub-package under Text::KnuthPlass 
(e.g., in the manner of PDF::Builder::Ladder under PDF::Builder), under either 
our ownership or yours.
